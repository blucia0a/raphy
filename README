...
A graph data structure library offering a few useful graph implementations.

_raphy::graph::Graph - A basic graph data structure_
...
_raphy::csr::CSR - A Compressed Sparse Row (CSR) graph data structure_
...
/CSR is currently an experimental feature and I do not recommend using it yet/
